...
class ViewChatPesan extends StatefulWidget {
  final data;
  final int idDosen;

  const ViewChatPesan({Key key, this.data, this.idDosen}) : super(key: key);
  @override
  _ViewChatPesanState createState() => _ViewChatPesanState();
}

class _ViewChatPesanState extends State<ViewChatPesan> {
        ...
        decoration: InputDecoration(
            ...
            suffixIcon: IconButton(
              ...
              onPressed: () async {
                ...
                final int idMahasiswa = await _dataShared.getId();
                Komentar komentar = Komentar(
                    null,
                    int.parse(widget.data['id_bahan']),
                    _tecKomentar.text,
                    idMahasiswa.toString(),
                    widget.idDosen.toString(),
                    null);
                await _komentarBahanProvider.addKomentarMahasiswa(
                    context, komentar);
                setState(() {
                  _tecKomentar.text = "";
                });
